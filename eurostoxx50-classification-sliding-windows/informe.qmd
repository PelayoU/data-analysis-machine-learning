...
$$
y_t = \begin{cases}
1 & \text{si } \dfrac{P_{t+50}}{P_t} - 1 > 0 \\[6pt]
...
: Características utilizadas en el modelo {#tbl-features}
...
```{r}
#| label: tbl-windows
#| tbl-cap: "Esquema de ventanas deslizantes"
...
```{r}
#| label: tbl-summary
#| tbl-cap: "Métricas medias (± desviación estándar) por modelo"
...
![AUC-ROC por año de test y modelo. La línea discontinua marca AUC = 0.5 (nivel del azar).](figures/auc_temporal.png){width=95%}
...
![Accuracy por año de test y modelo.](figures/accuracy_temporal.png){width=95%}
...
![Métricas agregadas por modelo.](figures/metrics_barplot.png){width=95%}
...
![Importancia de variables según Mean Decrease Gini en la última ventana de entrenamiento.](figures/rf_importance.png){width=85%}
